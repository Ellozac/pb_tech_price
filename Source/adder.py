...
class mainGUI:
    def __init__(self):
        ...
        self.button_pbtech = tk.Button(self.root, text="Open PbTech", command=self.openPbTech)
        self.button_pbtech.pack(padx=10,pady=10)

        
        self.root.mainloop()
    def openPbTech(self):
        # open pbtech.co.nz
        webbrowser.open("https://www.pbtech.co.nz/")
...
class viewGUI:
    def __init__(self):
        ...
        self.tree = ttk.Treeview(self.root, columns=("#0", "#1", "#2", "#3"))
        self.tree.column("#0")
        ...
        self.tree.column("#3")
        self.tree.heading("#3", text="Cost",anchor=tk.E )
        self.tree.pack()
